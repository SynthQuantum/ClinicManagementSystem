        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPredictedNoShow = table.Column<bool>(type: "bit", nullable: false),
                    NoShowProbability = table.Column<decimal>(type: "decimal(5,4)", precision: 5, scale: 4, nullable: true),
                    PredictedDurationMinutes = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PredictionType = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ProbabilityScore = table.Column<decimal>(type: "decimal(5,4)", precision: 5, scale: 4, nullable: false),
                    PredictedDurationMinutes = table.Column<int>(type: "int", nullable: true),
                    PredictedLabel = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    InputFeaturesJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PredictionResults_Appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VisitRecords_StaffMembers_StaffMemberId",
                        column: x => x.StaffMemberId,
                        principalTable: "StaffMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_AppointmentDate_StaffMemberId",
                table: "Appointments",
                columns: new[] { "AppointmentDate", "StaffMemberId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClinicSettings_ClinicName",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PredictionResults_AppointmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VisitRecords_StaffMemberId",
                table: "VisitRecords",
                column: "StaffMemberId");
        }
